...
MCTS_SIMULATIONS = 10
EPSILON = 1e-5
DIST_THRES_FOR_REWARD = 5                   # Threshold for reward for player forward distance difference
...
NUM_RESIDUAL_BLOCKS = 6                     # Number of residual blocks in the model

''' Train '''
SAVE_MODELS_DIR = 'saved-models/'
NUM_WORKERS = 2                            # For generating self plays in parallel
NUM_SELF_PLAY = 2                         # Total number of self plays to generate
