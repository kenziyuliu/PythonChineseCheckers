...
def evolve(cur_model_path, other_opponent_for_selfplay):
...
def build_parser():
    ...
    parser.add_argument('--model_path',
                    dest='model_path',
                    help='model_path of model to optimize on (newest model)')
    parser.add_argument('--best_model_path',
                    dest='best_model_path',
                    help='best model')
    parser.add_argument('--other_opponent_for_selfplay',
...
if __name__ == '__main__':
    ...
    evolve(model_path, args.other_opponent_for_selfplay)
